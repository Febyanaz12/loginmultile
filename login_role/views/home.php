...
if($_SESSION['role'] == 'admin'){ // Jika role-nya admin
    ...
    <div class="form-group">
        ...
        <ol style="margin-left: -25px;">
            <li>
                Akses menu home. Aksi yang diperbolehkan : tod
            </li>
            <li>
                Akses menu berita. Aksi yang diperbolehkan : kon
            </li>
            <li>
                Akses menu pengguna. Aksi yang diperbolehkan : tod
            </li>
            <li>
                Akses menu Kontak. Aksi yang diperbolehkan : tol
            </li>
        </ol>
    </div>
    <?php
